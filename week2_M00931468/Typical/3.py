...
latitude1, longitude1 = map(float, input(
    'Enter the first coordinate:\n').split(sep=','))
latitude2, longitude2 = map(float, input(
...
print(
    f'The distance between ({latitude1},{longitude1}) and ({latitude2},{longitude2}) is: {round(distance,0)} km')
